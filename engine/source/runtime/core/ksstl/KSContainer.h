...
namespace Kratos
{
    template <class T, class KSMemManagerClass = KSDefaultContainerMem>
    class KSContainer : public KSMemObject
    {
    protected:
    ...
    public:
        KSMemManagerClass m_MemManagerObject;
    };

    template <class KEY, class VALUE>
    class MapElement : public KSMemObject
    {
    public:
        KEY Key;
        VALUE Value;
